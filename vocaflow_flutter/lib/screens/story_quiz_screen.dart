...
class _StoryQuizScreenState extends State<StoryQuizScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (quizList.isEmpty) {
      return Scaffold(
        appBar: AppBar(title: const Text('Comprehension Quiz')),
        body: const Center(child: Text('No questions available for this story.')),
      );
    }
                  ...
                  if (_isAnswered)
                    ElevatedButton(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            _currentQuestionIndex == quizList.length - 1 ? 'Finish & Claim Bonus' : 'Next Question',
                        ...
                        .animate()
                        .fadeIn(duration: 400.ms)
                        .scale(begin: const Offset(0.95, 0.95), end: const Offset(1, 1), curve: Curves.elasticOut),
